...
namespace app {
    ...
    constexpr CommandArg<Vector> translation0{"translation", "Translation vector", zeroVec};
    constexpr CommandArg<float> translation0f{"translation", "Translation distance", 0.0f};
    ...
    constexpr Command<float, Vector> rotateXCmd{
        .name = "rotateX",
        .description = "Rotate about X axis",
        .args = {angle0, center0}
    };

    constexpr Command<float, Vector> rotateYCmd{
        .name = "rotateY",
        .description = "Rotate about Y axis",
        .args = {angle0, center0}
    };

    constexpr Command<float, Vector> rotateZCmd{
        .name = "rotateZ",
        .description = "Rotate about Z axis",
        .args = {angle0, center0}
    };
    ...
    constexpr Command<Vector, Vector> scaleVecCmd{
        .name = "scaleVec",
        .description = "Non-uniform scale",
        .args = {scaleVec1, center0}
    };

    constexpr Command<float, Vector> scaleXCmd{
        .name = "scaleX",
        .description = "Scale along X axis",
        .args = {scale1, center0}
    };

    constexpr Command<float, Vector> scaleYCmd{
        .name = "scaleY",
        .description = "Scale along Y axis",
        .args = {scale1, center0}
    };

    constexpr Command<float, Vector> scaleZCmd{
        .name = "scaleZ",
    ...
    constexpr Command<Vector> translateCmd{
        .name = "translate",
        .description = "Translate by vector",
        .args = {translation0}
    };

    constexpr Command<float> translateXCmd{
        .name = "translateX",
        .description = "Translate along X axis",
        .args = {translation0f}
    };

    constexpr Command<float> translateYCmd{
        .name = "translateY",
        .description = "Translate along Y axis",
        .args = {translation0f}
    };

    constexpr Command<float> translateZCmd{
        .name = "translateZ",
    ...
    constexpr auto allCommands = std::tuple{
        rotateCmd, rotateXCmd, rotateYCmd, rotateZCmd,
        scaleCmd, scaleVecCmd, scaleXCmd, scaleYCmd, scaleZCmd,
        translateCmd, translateXCmd, translateYCmd, translateZCmd
    };
}